...
257 тестов, полторы минуты. Покрыто всё, что проверяется без окна: геометрия трассы, поле расстояний, датчики, физика, чекпоинты, приспособленность, генетический алгоритм, логика виджетов, синтез звука, сохранения.
