...
Клик по любой машинке включает слежение за ней: жёлтое кольцо, лучи её датчиков и панель телеметрии слева внизу с показаниями всех семи датчиков, положением руля и газа. Когда машинка разбивается, слежение само переходит на ближайшую живую.
...
| клик по трассе | следить за этой машинкой |
...
Замер по двенадцати случайным сидам на настройках по умолчанию: доезжают восемь из двенадцати, в среднем за 8.5 поколений, и лишь у одного случайный мозг проезжает круг сразу. Одно поколение без графики считается за 0.27 секунды.
...
239 тестов, полторы минуты. Покрыто всё, что проверяется без окна: геометрия трассы, поле расстояний, датчики, физика, чекпоинты, приспособленность, генетический алгоритм, логика виджетов, синтез звука, сохранения.
