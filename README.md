...
267 тестов, полторы минуты. Покрыто всё, что проверяется без окна: геометрия трассы, поле расстояний, датчики, физика, чекпоинты, приспособленность, генетический алгоритм, логика виджетов, синтез звука, сохранения.
...
93 свойства, которые обязаны выполняться при любых входных данных, каждое прогоняется сотнями раз на случайных входах: 8724 проверки на круг. Тест стережёт придуманный автором сценарий, свойство стережёт договор целиком. Устройство разобрано в [docs/modules/stress.md](docs/modules/stress.md), находки в отчёте о проверке на баги.
