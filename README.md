...
Слева трасса и все пятьдесят машинок. Живые цветные, разбившиеся остаются лежать серыми, и по их скоплению сразу видно, в каком повороте гибнет поколение. У лидера жёлтое кольцо и видны лучи датчиков. Справа панель со статистикой, графиком обучения и настройками.
...
Замер по десяти случайным сидам на настройках по умолчанию: доезжают девять из десяти, в среднем за 12 поколений. Одно поколение без графики считается за 0.27 секунды.
...
231 тест, полторы минуты. Покрыто всё, что проверяется без окна: геометрия трассы, поле расстояний, датчики, физика, чекпоинты, приспособленность, генетический алгоритм, логика виджетов, синтез звука, сохранения.
